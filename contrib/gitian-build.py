...
def setup():
    ...
    if not os.path.isdir('whive'):
        subprocess.check_call(['git', 'clone', 'https://github.com/xyephy/whive.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/xyephy/whive', help='Specify the URL of the repository. Default is %(default)s')
