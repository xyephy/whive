...
<<<<<<< HEAD
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The whive address to use for the signature.\n"
...
static UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "whive-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\nwhive-cli has the option -getinfo to collect and format these in the old format."
    );
}
